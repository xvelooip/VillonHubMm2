...
--// ВКЛАДКА AUTOFARM (твой рабочий код)
do
    ...
    task.spawn(function()
        while true do
            ...
            if isInLobbyFlag then
                ...
                hum.Sit = false
                antiAfk(root)
                statusLabel.Text = "[ ОЖИДАЙТЕ ИГРЫ ]"
...
print("VillonHub обновлён. Автофарм с кнопками во вкладке, шот мардер финальный.")