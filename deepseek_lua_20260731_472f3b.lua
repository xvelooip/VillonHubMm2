--[[
    VILLONHUB TERMINAL ENGINE – Кастомное GUI (без стартового окна)
    Полная интеграция с исправленным пузырём
]]
...
-- ============================================================
--   GUI – КАСТОМНОЕ (с исправленным пузырём)
-- ============================================================
...
------------------------------------------------------------------
-- 1. ПУЗЫРЬ (с кнопкой для открытия)
------------------------------------------------------------------
...
-- Кнопка для открытия меню (занимает всю область, кроме левой зоны)
