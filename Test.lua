--[[
    ...
    GUI на WindUI (исправлено: конфиги, кнопки, change fling)
]]
...
TabAimbot:Button({
    ...
    Callback = function()
        ...
        if folder and folder:FindFirstChild("Aim_BindButton") then
            local btn = folder.Aim_BindButton
            btn.Draggable = IsAimBindEditModeActive
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local folder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if folder and folder:FindFirstChild("MM2_TPGunButton") then
            local btn = folder.MM2_TPGunButton
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local folder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if folder and folder:FindFirstChild("MM2_ShootMurderButton") then
            local btn = folder.MM2_ShootMurderButton
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local folder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if folder and folder:FindFirstChild("MM2_ThrowKnifeButton") then
            local btn = folder.MM2_ThrowKnifeButton
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local folder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if folder and folder:FindFirstChild("MM2_InvisButton") then
            local btn = folder.MM2_InvisButton
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local folder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if folder and folder:FindFirstChild("MM2_FlingButton") then
            local btn = folder.MM2_FlingButton
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local folder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if folder and folder:FindFirstChild("KillAllButton") then
            local btn = folder.KillAllButton
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local folder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if folder and folder:FindFirstChild("KillSheriffButton") then
            local btn = folder.KillSheriffButton
...
--// Configs (путь сохранения — папка VillonConfigs)
do
    ...
    TabConfigs:Button({
        ...
        Callback = function()
            ...
            if useFileSystem then
                ...
                showVillonNotice("Конфиг '" .. name .. "' сохранён в " .. configFolder)
            else
...
--// Change Fling (упрощён: клик по имени — сразу флинг)
do
    local function updateFlingPlayerList()
        -- Очищаем предыдущие кнопки (удаляем все дочерние элементы вкладки, но оставляем только те, что мы создаём)
...
showVillonNotice("VillonHub с WindUI загружен!")
print("VillonHub (исправленный) загружен.")