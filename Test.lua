--[[
    ...
    Без эмодзи. Полная версия: Combat, Visuals, MM2 (RoleESP с настройками), Misc, Configs, ChangeFling, VisualWorld
]]
...
--// Глобальная конфигурация (обновлена RoleESP)
local Options = {
    Aimbot = {
        Enabled = false,
        Radius = 120,
...
-- ============================================================
--   VISUAL WORLD EFFECTS (без изменений)
-- ============================================================
...
-- ============================================================
--   ШОТ МАРДЕР (новый, оптимизированный)
-- ============================================================
...
--// ESP (обычный и RoleESP с настройками)
        ...
        if char then
            ...
            if root and head and human and human.Health > 0 then
                ...
                if rootOn and headOn and legOn then
                    ...
                    -- Names для RoleESP (изменённый формат)
...
--// Функции создания элементов WindUI
...
do
    ...
    TabConfigs:Button({
        ...
        Callback = function()
            ...
            -- перезагружаем эффекты VisualWorld
            updateAllWorldEffects()
...
showVillonNotice("VillonHub загружен (без эмодзи)")
