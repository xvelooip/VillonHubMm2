--[[
    ...
    Полная версия: аим, ESP, шот мардер (кеш+асинхрон), флинг (кнопки), KillAll,
    VisualWorld (эффекты), Configs, растяг (тоггл в Misc)
    Без ChangeFling, обычная тёмная тема
]]
...
local Options = {
    ...
    Misc = {
        ...
        SpeedGlitchValue = 20,
        StretchEnabled = false   -- растяг по умолчанию выключен
    },
    VisualsWorld = {
        TrailEnabled = false,
        FogEnabled = false,
...
-- ============================================================
--   ШОТ МАРДЕР (НОВЫЙ – с кешем, предрасчётом, асинхронным выстрелом)
-- ============================================================
...
local MasterRenderLoop = RunService.RenderStepped:Connect(function()
    ...
    -- КНОПКА SHOOT MURDER (использует новый шот мардер)
...
-- ============================================================
--   РАСТЯГ (тоггл в Misc, по умолчанию выключен)
-- ============================================================
...
-- ============================================================
--   GUI – WINDUI (обычная тёмная тема)
-- ============================================================
...
--// Вкладки (ChangeFling заменена на VisualWorld)
...
-- Fling Murderer и Fling Sheriff – кнопки (одноразовое действие)
TabMM2:Button({
...
--// Вкладка VisualWorld (вместо ChangeFling)
...
--// Вкладка Configs (с сохранением/загрузкой Options и ButtonPositions)
do
...
showVillonNotice("VillonHub загружен (обычная тема)")
