...
--// Глобальная конфигурация (из deepko)
local Options = {
    Aimbot = {
        Enabled = false,
        Radius = 120,
...
-- ============================================================
--   GUI – WINDUI (все вкладки, включая Combat, Visuals, MM2, Misc, Configs, ChangeFling)
-- ============================================================
...
--// Вкладка ChangeFling (с галочками и кнопками FLING/STOP)
do
...
showVillonNotice("VillonHub загружен (полная версия с растягом, новым шот мардером, работающим Combat)")
