--[[
    ...
    GUI на WindUI (по образу рабочего автофарма)
    Без AutoFarm в меню
]]
...
local MasterRenderLoop = RunService.RenderStepped:Connect(function()
    ...
    -- === ВСЕ КНОПКИ (с правильным созданием папки) ===
...
-- ============================================
-- GUI — WINDUI (по образу автофарма)
-- ============================================
...
do
    ...
    local function updateFlingPlayerList()
        for _, btn in ipairs(playerButtons) do
            -- В WindUI нет прямого удаления, поэтому пересоздаём список
        end
        playerButtons = {}
        selectedPlayers = {}
        local players = {}
...
print("VillonHub с WindUI (без AutoFarm) загружен.")