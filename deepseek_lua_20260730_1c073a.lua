...
local MasterRenderLoop = RunService.RenderStepped:Connect(function()
    ...
    if Options.Aimbot.BindButtonEnabled then
        if not CoreGui:FindFirstChild("VillonHub_MM2_Menu") then
            CoreGui:FindFirstChild("VillonHub_MM2_Menu") = Instance.new("Folder")
            CoreGui:FindFirstChild("VillonHub_MM2_Menu").Name = "VillonHub_MM2_Menu"
        end
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder and menuFolder:FindFirstChild("Aim_BindButton") then
    ...
    if Options.MM2.TPGunButtonEnabled then
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder and menuFolder:FindFirstChild("MM2_TPGunButton") then
    ...
    if Options.MM2.InvisButtonEnabled then
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder and menuFolder:FindFirstChild("MM2_InvisButton") then
    ...
    if Options.MM2.FlingButtonEnabled then
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder and menuFolder:FindFirstChild("MM2_FlingButton") then
    ...
    if Options.MM2.ShootMurderButtonEnabled then
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder and menuFolder:FindFirstChild("MM2_ShootMurderButton") then
    ...
    if Options.MM2.ThrowKnifeButtonEnabled then
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder and menuFolder:FindFirstChild("MM2_ThrowKnifeButton") then
    ...
    if Options.MM2.KillAllButtonEnabled then
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder and menuFolder:FindFirstChild("KillAllButton") then
    ...
    if Options.MM2.KillSheriffButtonEnabled then
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder and menuFolder:FindFirstChild("KillSheriffButton") then
...
--// Функция для создания тоггла с автоматическим обновлением UI кнопок (если нужно)
local function CreateToggle(tab, text, configTable, configKey)
    local toggle = tab:Toggle({
        ...
        Callback = function(value)
            ...
            -- Обновление кнопок на экране (они автоматически перерисовываются в рендер-лупе)
        end
    })
    return toggle
end

--// Функция для числового поля
...
local aimBindToggle = CreateToggle(TabAimbot, "Show Aim Bind Button", "Aimbot", "BindButtonEnabled")
TabAimbot:Button({
    ...
    Callback = function()
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder then
            local btn = menuFolder:FindFirstChild("Aim_BindButton")
            if btn then
                btn.Draggable = IsAimBindEditModeActive
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder then
            local btn = menuFolder:FindFirstChild("MM2_TPGunButton")
            if btn then
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder then
            local btn = menuFolder:FindFirstChild("MM2_ShootMurderButton")
            if btn then
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder then
            local btn = menuFolder:FindFirstChild("MM2_ThrowKnifeButton")
            if btn then
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder then
            local btn = menuFolder:FindFirstChild("MM2_InvisButton")
            if btn then
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder then
            local btn = menuFolder:FindFirstChild("MM2_FlingButton")
            if btn then
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder then
            local btn = menuFolder:FindFirstChild("KillAllButton")
            if btn then
...
TabMM2:Button({
    ...
    Callback = function()
        ...
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder then
            local btn = menuFolder:FindFirstChild("KillSheriffButton")
            if btn then
...
--// Configs вкладка (полноценная, как в оригинале)
do
    ...
    -- Список конфигов
    local configListFrame = TabConfigs:CreateScrollingFrame({
    ...
    local function updateConfigList()
        ...
        for _, name in ipairs(names) do
            local btn = configListFrame:Button({
                Title = name,
                Callback = function()
...
--// Вкладка CHANGE FLING (полноценный список с выбором игроков)
do
    ...
    local function updateFlingPlayerList()
        ...
        for _, btn in ipairs(playerButtons) do
            -- Удаляем из UI (у WindUI нет удаления, но можно просто скрыть или пересоздать)
        end
        playerButtons = {}
        selectedPlayers = {}
        ...
        -- Для каждого создаём кнопку-переключатель
...
--// Функция выгрузки
local UnloadButton = TabMisc:Button({
    Title = "UNLOAD CHEAT",
    Callback = function()
        ...
        -- Удаляем меню WindUI
        Window:Destroy()
        -- Удаляем папку с кнопками
        local menuFolder = CoreGui:FindFirstChild("VillonHub_MM2_Menu")
        if menuFolder then menuFolder:Destroy() end
